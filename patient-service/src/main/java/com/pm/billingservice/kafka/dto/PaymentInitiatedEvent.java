package com.pm.billingservice.kafka.dto; // Note: package matches billing-service's DTO package

import java.time.LocalDateTime;

// This DTO is a copy from billing-service for patient-service to consume related events.
// Ideally, this would be in a shared library.
