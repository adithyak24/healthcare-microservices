...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<Map<String, String>> handleBadCredentialsException(
    ...
    Map<String, String> errors = new HashMap<>();
    errors.put("message", "Invalid email or password. Please check your credentials and try again.");
  ...
  public ResponseEntity<Map<String, String>> handleAuthenticationException(
    ...
    Map<String, String> errors = new HashMap<>();
    errors.put("message", "Authentication failed. Please check your credentials and try again.");
    return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(errors);
  }

  @ExceptionHandler(VisitNotFoundException.class)
  public ResponseEntity<Map<String, String>> handleVisitNotFoundException(
      VisitNotFoundException ex) {
    log.warn("Visit not found {}", ex.getMessage());

    Map<String, String> errors = new HashMap<>();
    errors.put("message", "Visit not found");
